...
const experiences = [
  {
    ...
    period: "2024 - 2025",
    description: [
      "Engineered a 4-DOF SCARA robot using stepper motors, BLDC motors, 3D printed parts, and harmonic drive reducers.",
      "Integrated pneumatic vacuum gripper end-effector for delicate object handling and manipulation.",
      "Developed forward and inverse kinematics algorithms with trajectory generation for precise robot motion control.",
      "Implemented real-time motion planning in ROS2 with MoveIt2 for autonomous path planning and collision avoidance.",
    ],
  ...
  },
  {
    ...
    description: [
      "Designed stepper motor driver PCB boards for 3DOF robot arm in agricultural automation applications.",
      "Designed and tested Battery Management System (BMS) for quadruped dog robot with charging protection and cell balancing.",
      "Tested and validated control systems using STM32CubeIDE to ensure proper motor performance and system reliability.",
  ...
  },
  {
    ...
    description: [
      "Co-taught beginner English evening classes alongside Khmer and French volunteer instructors.",
      "Organized and delivered lesson plans tailored to student proficiency levels for two groups of approximately 10 students each.",
      "Developed interactive teaching materials and assessment methods to support effective language learning and student progress.",
    ],
    technologies: ["English Teaching", "Communication", "Team Collaboration", "Language Education"],
    icon: Heart,
